...
export async function freshDb(): Promise<Db> {
  ...
  await db.execute(sql`truncate events, requests, request_offers, weave_invitations, participants, threads, weaves, keepers, settings, agents restart identity cascade`);
  return db;
}
