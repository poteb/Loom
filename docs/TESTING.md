...
As of the first external review round on PR #11 (last code commit `82d8670`): **494 tests in 46
files** — core 145, mcp-tools 21, server 95, client 33, cli 40, claude-channel 107, web 53 — run
