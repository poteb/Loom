...
As of the web main page on `feat/web-main-page` (last code commit `8943ba8`): **1138 tests in 60
files** — core 301 in 22, web 419 in 10, server 140 in 9, claude-channel 139 in 9, cli 68 in 5,
