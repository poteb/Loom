...
As of the guidelines sub-project (last code commit `099b89d`): **483 tests in 45 files** — core 143,
mcp-tools 20, server 95, client 33, cli 38, claude-channel 103, web 51 — run serially with
