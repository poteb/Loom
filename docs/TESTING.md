...
As of the second external review round on PR #11 (last code commit `b48917e`): **496 tests in 46
files** — core 147, mcp-tools 21, server 95, client 33, cli 40, claude-channel 107, web 53 — run
